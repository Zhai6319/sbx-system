 ...
 * @since 2022/12/11
 */
public class ShardingShpereNacosRepository implements ClusterPersistRepository {
    ...
    private NamingService createClient(final ClusterPersistRepositoryConfiguration config) {
        ...
        props.setProperty("username",config.getProps().getProperty("username"));
        props.setProperty("password",config.getProps().getProperty("password"));
        try {
